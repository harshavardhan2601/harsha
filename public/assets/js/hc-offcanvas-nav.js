							...
							n && (v.empty(), x = {}),
								function h(n, e, m, t, a) {
									...
									if (t && o.prepend("<h2>".concat(t, "</h2>")), _.each(n, function (n, e) {
										...
										var c = o.children("ul"),
											i = _('<li class="nav-back"><span></span><a href="#">'.concat(H.labelBack || "", "</a></li>"));
									...
									if (0 === m && !1 !== H.insertClose) {
										var s = o.children("ul"),
											l = _('<li class="nav-close"><span></span><a href="#">'.concat(H.labelClose || "", "</a></li>"));
