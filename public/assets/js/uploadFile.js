...
$(document).ready(function () {
    ...
    for (var i = 0; i < dn_arr.length; i++) {
       ...
       var html="<label class ='file-input' for='file-input'><i class='fa fa-paperclip fa-lg' aria-hidden='true'></i></label><input  class='custom-file-input' id='file-input' type='file' name='" + dname + "' onchange='uploadFile(\"" + dname + "\")' />";
